...
implements ReceiveDataChangedListener , SendDataChangedListener
{
    ...
    public void ReceiveDataChanged()
    {
        ...
        jTextArea1.append("\n");
       // jTextFieldIdentifier.setText(Integer.toHexString(modbusClient.unitIdentifier));
    }
    ...
    private void initComponents() {
        ...
        jTextFieldIdentifier.setText("101");
        			...
        			.addGroup(jPanel1Layout.createParallelGroup(Alignment.TRAILING)
        				...
        				.addGroup(jPanel1Layout.createSequentialGroup()
        					...
        					.addComponent(jLabelIdentifier)
                                                .addGap(0, 0, Short.MAX_VALUE)
                                                .addComponent(jTextFieldIdentifier, GroupLayout.PREFERRED_SIZE, 48, GroupLayout.PREFERRED_SIZE)
        					.addGap(0, 0, Short.MAX_VALUE)))
        			.addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
        	jPanel1Layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(jPanel1Layout.createSequentialGroup()
        			...
        			.addComponent(jLabelIdentifier)
                                .addGap(10)
                                .addComponent(jTextFieldIdentifier, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
        ...
        if (!modbusClient.isConnected())
        {
        	if (this.comboBox.getSelectedItem() == "Modbus TCP")
        	{
        		...
        		modbusClient.setPort(Integer.valueOf(jTextFieldPort.getText()));
                        modbusClient.setUnitIdentifier(Byte.valueOf(jTextFieldIdentifier.getText(),1));
        		try
        		{
       ...
       if (!modbusClient.isConnected())
        {
        	...
        	else
            {
            	try
            	{
					modbusClient.setUnitIdentifier(Short.valueOf(jTextFieldIdentifier.getText()));
            		modbusClient.Connect(txtCom.getText());
            	}
            	catch (Exception e)
            	{
